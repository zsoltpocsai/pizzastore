...
$rendeles_szam_file = fopen("data/rendelesek/rendeles_szam.txt", "r");
$rendeles_szam = trim(fgets($rendeles_szam_file));
fclose($rendeles_szam_file);

$rendeles_szam_file = fopen("data/rendelesek/rendeles_szam.txt", "w");
...
$rendeles_file = fopen("data/rendelesek/" . $rendeles_szam . ".txt", "w");
